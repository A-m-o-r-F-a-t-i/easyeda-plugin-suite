...
| 直接子模块 | 当前版本 | 公开仓库 | 作用 |
| --- | ---: | --- | --- |
| `plugins/easyeda-ai-plugin` | 2.9.2 | [`easyeda-ai-plugin`](https://github.com/A-m-o-r-F-a-t-i/easyeda-ai-plugin) | 聚合 5 个 Skill（PCB Skill 5.5.2）与 PCB MCP 2.5.0；新板框以原点为中心，小型板可一次完成最多 100 个展开布局操作，每轮跨对象焊盘重叠清零后才允许继续 |
